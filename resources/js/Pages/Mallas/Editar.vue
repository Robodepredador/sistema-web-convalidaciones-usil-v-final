...
<template>
    <div class="max-w-4xl mx-auto pb-12">
        ...
        <!-- Header -->
        <div class="mb-6">
            <div class="inline-flex items-center gap-2 px-3 py-1 mb-2 rounded-full bg-blue-50 border border-blue-100 text-[#0036DC]">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-[#00205B] tracking-tight">Editar Malla Curricular</h1>
            ...
            <div class="bg-white rounded-3xl border border-slate-200/70 shadow-sm p-6 sm:p-8 relative overflow-hidden">
                ...
                <div class="mb-8 p-5 rounded-2xl bg-gradient-to-r from-slate-50 via-blue-50/30 to-slate-50 border border-slate-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div class="h-12 w-12 rounded-2xl bg-[#00205B] text-white flex items-center justify-center shadow-sm shrink-0">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 pt-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit" :disabled="form.processing"
                            class="inline-flex items-center gap-2 rounded-xl bg-[#00205B] hover:bg-[#0036DC] px-6 py-2.5 text-sm font-bold text-white shadow-md hover:shadow-lg hover:scale-102 active:scale-98 transition-all duration-200 disabled:opacity-60">
