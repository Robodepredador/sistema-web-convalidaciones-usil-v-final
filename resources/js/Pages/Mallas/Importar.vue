...
<template>
    <div class="w-full pb-16">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold text-[#00205B] tracking-tight">Importar Malla desde Excel</h1>
        ...
        <div class="grid gap-8 lg:grid-cols-12 items-start">
            ...
            <div class="lg:col-span-7 bg-white rounded-3xl border border-slate-200/70 shadow-sm p-6 sm:p-8 relative overflow-hidden">
                ...
                <form @submit.prevent="enviar" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1 flex justify-center rounded-2xl border-2 border-dashed border-slate-300 px-6 pt-6 pb-6 hover:border-[#0036DC] hover:bg-blue-50/20 transition-all duration-200 group text-center">
                            <div class="space-y-2">
                                ...
                                <div class="text-xs text-slate-600">
                                    <label class="relative cursor-pointer font-bold text-[#0036DC] hover:text-[#00205B]">
                        ...
                        <div v-if="form.progress" class="mt-2">
                            <div class="h-1.5 w-full rounded-full bg-slate-100 overflow-hidden">
                                <div class="h-full bg-[#0036DC] transition-all duration-200" :style="{ width: `${form.progress.percentage}%` }"></div>
                            </div>
                    ...
                    <div class="flex items-center justify-between gap-4 pt-4 border-t border-slate-100">
                        ...
                        <button type="submit" :disabled="form.processing || !form.archivo || !form.carrera_id"
                                class="inline-flex items-center gap-2 rounded-xl bg-[#00205B] hover:bg-[#0036DC] px-6 py-2.5 text-sm font-bold text-white shadow-md hover:shadow-lg hover:scale-102 active:scale-98 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            <div class="lg:col-span-5 space-y-5">
                <div class="bg-gradient-to-br from-slate-50 to-blue-50/40 rounded-3xl border border-slate-200/80 p-6 shadow-sm">
                    <h3 class="text-sm font-bold text-[#00205B] flex items-center gap-2 mb-3">
                    ...
                    <div class="mt-6 pt-4 border-t border-slate-200/60">
                        <a href="/mallas/plantilla" target="_blank"
                           class="inline-flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-white border border-slate-300 text-xs font-bold text-[#00205B] hover:bg-blue-50 transition-colors shadow-2xs">
                            <svg class="w-4 h-4 text-[#0036DC]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
