                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-end gap-2">
                                            <div class="flex items-center gap-1">
                                                ...
                                                <button v-if="c.excel_oficial_preconv" @click="descargarArchivo(c.excel_oficial_preconv)" title="Descargar Excel Oficial" class="rounded p-1 text-slate-400 hover:bg-slate-100 hover:text-teal-600">
