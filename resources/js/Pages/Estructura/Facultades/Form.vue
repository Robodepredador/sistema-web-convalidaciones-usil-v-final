                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select v-model="form.unidad_negocio_id" required
                                :class="form.errors.unidad_negocio_id ? 'border-red-300 ring-2 ring-red-100' : 'border-slate-200 focus:border-[#2E75B6] focus:ring-3 focus:ring-blue-100'"
                                class="w-full rounded-xl border bg-slate-50/50 px-4 py-2.5 text-xs text-slate-800 focus:bg-white focus:outline-hidden transition-all duration-200">
                        ...
                        <div v-if="!sedes.length" class="mt-1 text-xs text-amber-600">
                            No hay sedes registradas. <Link href="/estructura/sedes/crear" class="font-bold text-[#2E75B6] underline">+ Agregar sede</Link>
                        </div>
                    </div>
                </div>
