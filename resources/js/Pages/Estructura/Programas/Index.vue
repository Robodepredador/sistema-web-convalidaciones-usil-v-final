                        ...
                        <tr v-for="p in programas.data" :key="p.id" class="hover:bg-slate-50/70 transition-colors">
                            ...
                            <td class="px-5 py-4 text-center">
                                <Link :href="`/mallas?carrera_id=${p.id}`"
                                      class="inline-flex items-center justify-center rounded-xl bg-sky-50 px-3 py-1 text-xs font-bold text-[#1F3864] border border-sky-100 hover:bg-sky-100 transition-colors">
